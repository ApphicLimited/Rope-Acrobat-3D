...
public class CFX_Demo_GTToggle : MonoBehaviour
{
	...
	void Awake()
	{
	//	CollisionRect = this.GetComponent<Texture>().GetScreenRect(Camera.main);
	...
	void Update ()
	{
		...
		{
			Over = false;
			//this.GetComponent<Texture>().color = NormalColor;
		}
	...
	private void UpdateTexture()
	{
		...
		if(Over)
		{
		//	this.GetComponent<Texture>().texture = Hover;
		}
		else
		//	this.GetComponent<Texture>().texture = Normal;
		
		//this.GetComponent<Texture>().color = col;
